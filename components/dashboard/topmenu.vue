      ...
      <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item dropdown d-none d-lg-block">
          ...
          >
            ...
            >
              <p class="p-3 mb-0 text-center">See all projects</p></nuxt-link
            >
          </div>
        </li>
        ...
        <li class="nav-item dropdown">
          <a
            ...
            data-toggle="dropdown"
          >
            <div v-if="loggedIn" class="navbar-profile">
          ...
          >
            ...
            <a class="dropdown-item preview-item">
              ...
              <div class="preview-item-content">
                <p @click="logout" class="preview-subject mb-1">Log out</p>
              </div>
            </a>
            <div class="dropdown-divider"></div>
...
export default {
  ...
  methods: {
    async getDataCourses() {
      const response = await this.$axios.get(`/api/courses/get-all-courses`);
